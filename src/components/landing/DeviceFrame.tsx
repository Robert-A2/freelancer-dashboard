...
export default function DeviceFrame({ children }: { children: ReactNode }) {
  ...
  return (
    <div ref={ref} className="relative py-8">
      ...
      <div
        className="pointer-events-none absolute left-[6%] right-[20%] bottom-2 h-10 rounded-[50%] blur-2xl opacity-40"
      ...
      >
        {/* Frame — a thin, plain border instead of a heavy metal bezel */}
        <div className="relative rounded-2xl border border-[#1E3550] bg-[#0D1B2B] shadow-[0_16px_40px_-16px_rgba(0,0,0,0.35)] overflow-hidden">
