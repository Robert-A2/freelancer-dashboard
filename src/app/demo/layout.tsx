  ...
  return (
    <div className="min-h-screen bg-[#0D1B2B] overflow-x-hidden">
      ...
      <div className="bg-[#D4A25410] border-b border-[#D4A25430]">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-8 xl:px-12 py-2 flex items-center gap-2">
      ...
      <main className="max-w-[1280px] mx-auto px-5 pt-8 pb-28 sm:px-6 lg:px-8 xl:px-12 min-[1400px]:pt-12 min-[1400px]:pb-12">
        {children}
      </main>
    </div>
  );
